...
<!-- Pretty photo -->
   ...
   <div id="con" style="margin:20px">
		            ...
		            <h1 style="font-family: Cambria;">Management system for real estate agencies</h1>
		            ...
		            <p style="font:14px/1.8em Arial,Helvetica,sans-serif;text-align: justify;">
		            	This management system helps reals estate agent to search properties, applicants, match properties and applicants, make appointments and generate reports. 
		            </p>
					<br/>
					<p style="font:14px/1.8em Arial,Helvetica,sans-serif;text-align: justify;">
						It helps real estate brokers and agents achieve their goals by enabling them to become more powerful, more productive and more profitable.
					</p>
					...
					<div class="w2" style="height:355px;"> 
						<div class="thumb">
							<a title="" href="images/works/realestate/new/realtor_property.png" rel="prettyPhoto[gallery_1]"  class="gallery clearfix" >
								<img src="images/works/realestate/new/realtor_property.png"  alt="Property window" />
							</a>
						</div> 
						<h4 style="margin: 4px; padding: 10px;    color: #223344;font-size: 16px;font-weight: normal;">Property window</h4> 
						<p style="font:14px/1.8em Arial,Helvetica,sans-serif;">This window is used to add and edit properties.</p> 
						<div class="clear"> </div> 
					</div>
					...
					<div  class="w2" style="height:310px;"> 
						<div class="thumb">
							<a title="" href="images/works/realestate/new/realtor_calendar.png" rel="prettyPhoto[gallery_1]"  class="gallery clearfix" >
								<img src="images/works/realestate/new/realtor_calendar.png"  alt="Calendar window" />
							</a>
						</div> 
						<h4 style="margin: 4px; padding: 10px; color: #223344;font-size: 16px;font-weight: normal;">Calendar window</h4> 
						<p style="font:14px/1.8em Arial,Helvetica,sans-serif;">Calendar is used to add appointments.</p> 
						<div class="clear"> </div> 
					</div>
